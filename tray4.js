...
const temperatureRef = firebase.database().ref('Tray4/Temp'); // Theo dõi nhiệt độ
const humidityRef = firebase.database().ref('Tray4/Hum'); // Theo dõi độ ẩm
const dayRef = firebase.database().ref('Tray4/Day'); // Theo dõi ngày
